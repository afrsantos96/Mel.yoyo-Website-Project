...
const About = () => (
    <div className='about'>
        <div className='about-row row'>
            <div className='col-4'>
                <img src='./media/images/about/mel.png' className='about-mel-img' width='300px'></img>
            </div>
        ...
        <div className='about-row row'>
            ...
            <div className='col-4'>
                <img src='./media/images/about/studio.jpg' className='about-mel-img' width='300px'></img>
            </div>
        </div>
    </div>
)
